...
mavenPublishing {
    ...
    coordinates("io.github.ivamsi", "ticker-coroutines", version.toString())

    pom {
        name.set("Ticker Coroutines")
        description.set("Keeps kotlin.time.Clock in step with kotlinx-coroutines-test virtual time")
